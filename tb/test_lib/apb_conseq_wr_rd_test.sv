class apb_conseq_wr_rd_test extends apb_base_test;
	`uvm_component_utils(apb_conseq_wr_rd_test)

	apb_write_seq wrseq;
	apb_read_seq rdseq;

	function new(string name="apb_conseq_wr_rd_test", uvm_component parent=null);
